...
namespace VoxelBusters.ReplayKit.Internal
{
	public class Constants : MonoBehaviour
	{
        ...
        public const string kAndroidPluginsReplayKitPath		= kPluginsAndroidLibraryRootPath + "/replay_kit_lib.androidlib";
#else
        public const string kAndroidPluginsReplayKitPath		= kPluginsAndroidLibraryRootPath + "/replay_kit_lib";
#endif
